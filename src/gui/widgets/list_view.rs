/// DISCLAIMER!!
/// This code was provided by BonnyAD9 (and he definitelly knows it)
/// https://github.com/BonnyAD9/uamp/blob/master/src/gui/widgets/wrap_box.rs
...
use crate::gui::svg_data::{SCROLL_DOWN, SCROLL_UP};
    ...
    Renderer::Theme: StyleSheet,
{
    ...
    fn draw_scrollbar(
        ...
        renderer.draw(SCROLL_UP.into(), Some(b_style.foreground), top_button);
