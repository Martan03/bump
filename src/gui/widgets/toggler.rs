...
where
    Renderer: text::Renderer,
    Renderer::Theme: StyleSheet + iced::widget::text::StyleSheet,
{
    ...
    fn draw(
        ...
        let toggler_style = if is_mouse_over {
        ...
        renderer.fill_quad(
            renderer::Quad {
                ...
                border_width: 1.0,
                border_color: toggler_style
                    .background_border
                    .unwrap_or(toggler_style.background),
            },
            toggler_style.background,
        );
        ...
        renderer.fill_quad(
            renderer::Quad {
                ...
                border_color: toggler_style
                    .foreground_border
                    .unwrap_or(toggler_style.foreground),
            },
...
use iced_core::{
    ...
    event, layout, mouse, renderer, text, touch,
    widget::Tree,
    Alignment, Clipboard, Color, Element, Event, Layout, Length, Pixels,
